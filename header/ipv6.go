...
const (
	...
	IPv6ProtocolNumber global.NetworkProtocolNumber = 0x86dd
...
func (b IPv6) TransportProtocol() global.TransportProtocolNumber {
	return global.TransportProtocolNumber(b.NextHeader())
}
...
func (b IPv6) SourceAddress() global.Address {
	return global.Address(b[v6SrcAddr : v6SrcAddr+IPv6AddressSize])
}

// DestinationAddress returns the "destination address" field of the ipv6
// header.
func (b IPv6) DestinationAddress() global.Address {
	return global.Address(b[v6DstAddr : v6DstAddr+IPv6AddressSize])
}
...
func IsV4MappedAddress(addr global.Address) bool {
