...
const (
	...
	IPv4ProtocolNumber global.NetworkProtocolNumber = 0x0800
...
func (b IPv4) SourceAddress() global.Address {
	return global.Address(b[srcAddr : srcAddr+IPv4AddressSize])
}

// DestinationAddress returns the "destination address" field of the ipv4
// header.
func (b IPv4) DestinationAddress() global.Address {
	return global.Address(b[dstAddr : dstAddr+IPv4AddressSize])
}

// TransportProtocol implements Network.TransportProtocol.
func (b IPv4) TransportProtocol() global.TransportProtocolNumber {
	return global.TransportProtocolNumber(b.Protocol())
}
