...
func main() {
	...
	go hearFromNet(listenEP, s, "0.0.0.0", 40000)
	//go hearFromNet(listenEP, s, "0.0.0.0", 40001)
	//go hearFromNet(listenEP, s, "0.0.0.0", 40002)
	//go hearFromNet(listenEP, s, "0.0.0.0", 40003)
